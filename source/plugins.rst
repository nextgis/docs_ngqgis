...
1. Check if original plugin’s name is in other language.
2. Check the Settings tab: repositories should be marked as green. If the mark is red, it means problems with Internet connection or with server.
