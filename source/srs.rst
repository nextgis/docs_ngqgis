...
Чтобы изменить проекцию, в которой отображаются данные проекта, нажмите вторую справа кнопку в правом нижнем углу.
...
Откроется окно свойств проекта, в котором можно `выбрать необходимую проекцию <https://docs.nextgis.ru/docs_ngqgis/source/srs.html#proj-srs-parameters-pic>`_.

.. _ngq_projections_squished:
...
значение можно изменить, ``Настройки ‣ Параметры ‣ Вкладка Система координат ‣ Подвкладка CRS Handling ``. 
Указанное значение будет использоваться по всех последующих сеансах работы.

Первая вкладка настроек систем координат окна Параментры представлена на рисунке:
...
На рисунке показаны возможные варианты:
...
.. raw:: html
   ...
   <iframe width="560" height="315" src="https://rutube.ru/play/embed/b4fe4bdb474cc97b16d9faa7090588b9/" frameBorder="0" allow="clipboard-write; autoplay" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>

Смотреть на `youtube <https://youtu.be/DTnjb836YBA>`_, `rutube <https://rutube.ru/video/b4fe4bdb474cc97b16d9faa7090588b9/>`_.
...
А пункт "Выбрать систему координат слоя для проекта" устанавливает в качестве системы координат 
проекта СК слоя.
...
Нажмите |green_plus|, чтобы добавить новую СК. Заполните следующие поля:

.. |green_plus| image:: _static/symbologyAdd.png
   :alt: зелёный знак плюс
...
Также можно проверить создаваемую СК при помощи значений широты и долготы WGS-84. Введите их в соответствующие поля, нажмите кнопку "Рассчитать" и сравните результат с известными значениями вашей проекции.
