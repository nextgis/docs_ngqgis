...
.. figure:: _static/UIAttributeTable1.png
   ...
   Меню "Открыть таблицу атрибутов": 1. Выбрать слой. 2. В меню выберите пункт Слой. 3. Выбрать 
...
полей и недоступен для некоторых типов данных, например csv. При работе с WFS, PostGIS, 
Shapefile и другими базами данных он должен выполняться быстрее.
