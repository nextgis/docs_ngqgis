...
1. В свойства проекта --> Общие выставить Эллипсоид для вычислений - WGS 1984, единицы для измерения длинн - метры, единицы для измерения площадей - квадратные километры.
