...
1. В свойствах проекта --> Общие выставить Эллипсоид для вычислений - WGS 1984, единицы для измерения длинн - метры, единицы для измерения площадей - квадратные километры (см. :numref:`_project_settings`).
...
3. Выделить слой, зайти в калькулятор полей, создать поле. Название поля - например square, тип real, размер 20, точность 10. 
...
Любое редактирование начинается с выбора функции Режим редактирования. 
