...
.. admonition:: Хотите научиться добавлять объекты по координатам, выявлять ошибки геометрии и анализировать векторные данные?
   Этому и многому другому можно научиться на нашем онлайн-курсе `Фундаментальный QGIS <https://nextgis.skillspace.ru/l/qgis>`_
...
1. Сортировка по полю (треугольник, появляющийся при наведении на заголовок столбца, указан стрелочкой на рисунке ниже).
...
* to_decimal, to_dms - конвертирует координаты из градусов-минут-секунд в десятичные градусы и обратно: ``to_decimal('6°21'16.445') → 6.3545680555``, ``to_dms(6.1545681, 'x', 3) → 6°9′16.445″``
...
.. _ngqgis_editing_field_calc_short:
...
См. подраздел `Создание новых слоёв <https://docs.nextgis.ru/docs_ngqgis/source/map.html#ngqgis-create-new-layer>`_. 
...
2. Панель инструментов и раскрывающаяся панель "Дополнительные инструменты оцифровки"
...
.. figure:: _static/drawing_tools_additional.png
   :name: drawing_tools_additional_pic
   :align: center
   :height: 1cm
   
   Панель инструментов "Дополнительные инструменты оцифровки"

.. figure:: _static/advanced_digitizing_panel_daXYzm_ru.png
   :name: advanced_digitizing_panel_pic
   :align: center
   :width: 9cm

   Панель "Дополнительные инструменты оцифровки"

Для рисования включите панель инструментов "Инструменты оцифровки".
...
Посмотреть видео на `youtube <https://youtu.be/uk9pPQhtRpI>`__, `rutube <https://rutube.ru/video/1b375b6fb65e4ebf7cd4e8f369a6277a/>`__.
...
Для активации этого режима перейдите в ``Проект ‣ Параметры прилипания`` (см. рисунок)  и нажмите кнопку **Топологическое редактирование**.
