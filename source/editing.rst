...
Используя инструмент "Разбить объекты", можно разрезать объект 
пополам, нарисовав линию через него. Получается два объекта с одинаковыми атрибутами.
...
на части. Получается один мултиполигональный объект из двух частей.
