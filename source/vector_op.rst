...
Для каждого обьекта строит охватывающий прямоугольник, который повёрнут так, что бы получалась меньшая площадь. В атрибуты записывается 
...
.. figure:: _static/vectortools_Oriented_MBBox.png
   ...
   Ориентированые охватывающие прямоугольники построенные для слоя территорий городов
