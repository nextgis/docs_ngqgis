...
.. figure:: _static/ngqgis_spatial_sample.png
   ...
   Интрумент для работы с векторными данными - Пространственная выборка.
...
.. figure:: _static/ngqgis_polygon_from_the_boundary_layer.png
   ...
   Интрумент для работы с векторными данными - Полигон из границ слоя.
...
.. figure:: _static/ngqgis_convex_shells.png
   ...
   Интрумент для работы с векторными данными - Выпуклые оболочки.
...
.. figure:: _static/ngqgis_buffer_zones.png
   ...
   Интрумент для работы с векторными данными - Буферные зоны.
...
.. figure:: _static/ngqgis_crossing.png
   ...
   Интрумент для работы с векторными данными - Пересечение.
...
.. figure:: _static/ngqgis_integration.png
   ...
   Интрумент для работы с векторными данными - Объединение.
...
.. figure:: _static/ngqgis_difference.png
   ...
   Интрумент для работы с векторными данными - Разность.
...
.. figure:: _static/ngqgis_symmetrical_difference.png
   ...
   Интрумент для работы с векторными данными - Симметричная разность.
...
.. figure:: _static/ngqgis_unification_on_the_basis_of.png
   ...
   Интрумент для работы с векторными данными - Объединение по признаку.
...
.. figure:: _static/ngqgis_fragmentation_polygons.png
   ...
   Интрумент для работы с векторными данными - Удаление осколочных полигонов.
