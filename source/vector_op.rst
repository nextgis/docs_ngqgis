...
* Новый способ: через модуль Processing (Инструменты анализа). Этим способом пользоваться удобнее. Некоторые инструменты доступны только в нём.
...
.. figure:: _static/vector_analysis_menu_ru.png
   :align: center
   :width: 18cm
   :name: vector_analysis_menu_pic
   
   Выпадающее меню Анализ

.. |mAlgorithmLineIntersections| image:: _static/mAlgorithmLineIntersections.png
.. |mAlgorithmMeanCoordinates| image:: _static/mAlgorithmMeanCoordinates.png
.. |mAlgorithmBasicStatistics| image:: _static/mAlgorithmBasicStatistics.png
.. |mAlgorithmSumPoints| image:: _static/mAlgorithmSumPoints.png
.. |mAlgorithmDistanceMatrix| image:: _static/mAlgorithmDistanceMatrix.png
.. |mAlgorithmUniqueValues| image:: _static/mAlgorithmUniqueValues.png
.. |mAlgorithmNearestNeighbour| image:: _static/mAlgorithmNearestNeighbour.png
.. |mAlgorithmSumLengthLines| image:: _static/mAlgorithmSumLengthLines.png



.. _ngq_vector_op_countpointsinpoly:

Подсчёт точек в полигоне
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmSumPoints| Подсчет точек в полигоне:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmNearestNeighbour| Анализ ближайших соседей
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmSumLengthLines| Сумма длин:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmDistanceMatrix| Матрица расстояний:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmUniqueValues| Список уникальных значений:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmBasicStatistics| Базовая статистика для полей:
...
.. |mAlgorithmCreateGrid| image:: _static/mAlgorithmCreateGrid.png
.. |mAlgorithmRandomPointsOnLines| image:: _static/mAlgorithmRandomPointsOnLines.png
.. |mAlgorithmRandomPointsWithinExtent| image:: _static/mAlgorithmRandomPointsWithinExtent.png
.. |mAlgorithmRandomPointsInPolygons| image:: _static/mAlgorithmRandomPointsInPolygons.png
.. |mAlgorithmRegularPoints| image:: _static/mAlgorithmRegularPoints.png

Вызываются через панель Инструменты анализа или меню Вектор ‣ Анализ :numref:`vector_analysis_menu_pic`.
...
Операция запускается через через панель Инструменты анализа в разделе "Вектор - Создание" или в меню Вектор ‣ Анализ ‣ |mAlgorithmCreateGrid| Создать сетку:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmLineIntersections| Пересечение линий:
...
Операция запускается из панели Инструменты анализа или через меню Вектор ‣ Анализ ‣ |mAlgorithmMeanCoordinates| Средние координаты:
...
Операция запускается через через панель Инструменты анализа в разделе "Вектор - Создание" или в меню Вектор ‣ Анализ ‣ |mAlgorithmRandomPointsInPolygons| Случайные точки в полигонах.
...
Операция запускается через панель Инструменты анализа в разделе "Вектор - создание" или через меню Вектор ‣ Анализ ‣ |mAlgorithmRandomPointsOnLines| Случайные точки по линии:
...
Операция запускается через через панель Инструменты анализа в разделе "Вектор - Создание" или в меню Вектор ‣ Анализ ‣ |mAlgorithmRandomPointsWithinExtent| Случайные точки в границах слоя.
...
Операция запускается через через панель Инструменты анализа в разделе "Вектор - Создание" или в меню Вектор ‣ Анализ ‣ |mAlgorithmRegularPoints| Регулярные точки.
...
Запускается через панель Инструменты анализа в разделе "Вектор - Выборка". Некоторые из них также доступны в меню Вектор ‣ Анализ :numref:`vector_analysis_menu_pic`.
...
.. |mAlgorithmSelectRandom| image:: _static/mAlgorithmSelectRandom.png
.. |mAlgorithmSelectLocation| image:: _static/mAlgorithmSelectLocation.png
.. |mAlgorithmSelectDistance| image:: _static/mAlgorithmSelectDistance.png
...
Операция запускается через панель Инструменты анализа в разделе "Вектор - Выборка" или в меню Вектор ‣ Анализ ‣ |mAlgorithmSelectLocation| Выбрать по расположению:
...
Операция запускается через панель Инструменты анализа в разделе "Вектор - Выборка" или в меню Вектор ‣ Анализ ‣ |mAlgorithmSelectRandom| Случайное выделение:
...
Операция запускается через панель Инструменты анализа в разделе "Вектор - Выборка" или в меню Вектор ‣ Анализ ‣ |mAlgorithmSelectRandom| Случайное выделение в подмножествах:
...
Операция запускается через панель Инструменты анализа. Алгоритм выделяет объекты векторного слоя, находящиеся в пределах указанного максимального расстояния от объектов другого слоя.
...
.. figure:: _static/ngqgis_extract_within_distance_ru.png
   ...
   Инструмент для работы с векторными данными - |mAlgorithmSelectDistance| Выделить в пределах расстояния
...
.. |mAlgorithmBuffer| image:: _static/mAlgorithmBuffer.png
.. |mAlgorithmClip| image:: _static/mAlgorithmClip.png
.. |mAlgorithmConvexHull| image:: _static/mAlgorithmConvexHull.png
.. |mAlgorithmDifference| image:: _static/mAlgorithmDifference.png
.. |mAlgorithmDissolve| image:: _static/mAlgorithmDissolve.png
.. |mAlgorithmSymmetricalDifference| image:: _static/mAlgorithmSymmetricalDifference.png
.. |mAlgorithmUnion| image:: _static/mAlgorithmUnion.png
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmBuffer| Буфер:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmConvexHull| Выпуклая оболочка:
...
Операция запускается из панели Инструменты анализа (раздел "Инструменты пространственных операций") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmUnion| Объединение:
...
Операция запускается из панели Инструменты анализа (раздел "Инструменты пространственных операций") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmClip| Обрезать:
...
Посмотреть видео на `youtube <https://youtu.be/wtJUcl2RO0U>`_, `rutube <https://rutube.ru/video/3744cf77fa34689b2b7aa99d54003169/>`__.
...
Операция запускается из панели Инструменты анализа (раздел "Инструменты пространственных операций") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmDifference| Разность:
...
Операция запускается из панели Инструменты анализа (раздел "Инструменты пространственных операций") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmSymmetricalDifference| Симметричная разность:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmDissolve| Объединение по признаку:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Геообработка ‣ |mAlgorithmDissolve| Удалить выбранные полигоны (присоединить к соседним):
...
.. |mAlgorithmCentroids| image:: _static/mAlgorithmCentroids.png
.. |mAlgorithmCollect| image:: _static/mAlgorithmCollect.png
.. |mAlgorithmExtractVertices| image:: _static/mAlgorithmExtractVertices.png
.. |mAlgorithmMultiToSingle| image:: _static/mAlgorithmMultiToSingle.png
.. |mAlgorithmPolygonToLine| image:: _static/mAlgorithmPolygonToLine.png
.. |mAlgorithmSimplify| image:: _static/mAlgorithmSimplify.png
.. |mAlgorithmCheckGeometry| image:: _static/mAlgorithmCheckGeometry.png
.. |mAlgorithmDelaunay| image:: _static/mAlgorithmDelaunay.png
.. |processingAlgorithm| image:: _static/processingAlgorithm.png
.. |mAlgorithmAddGeometryAttributes| image:: _static/mAlgorithmAddGeometryAttributes.png
.. |mAlgorithmLineToPolygon| image:: _static/mAlgorithmLineToPolygon.png
.. |mAlgorithmVoronoi| image:: _static/mAlgorithmVoronoi.png
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmCentroids| Центроиды:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmCollect| Собрать геометрии:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |processingAlgorithm| Добавить вершины:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmExtractVertices| Извлечь вершины:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmMultiToSingle| Разбить составную геометрию:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmPolygonToLine| Полигоны в линии:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmSimplify| Упростить:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmCheckGeometry| Проверка геометрии:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmDelaunay| Триангуляция Делоне:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmAddGeometryAttributes| Добавить атрибуты геометрии:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmLineToPolygon| Линии в полигоны:
...
Операция запускается из панели Инструменты анализа (раздел "Вектор - Геометрия") или через пункт меню Вектор ‣ Обработка геометрии ‣ |mAlgorithmVoronoi| Полигоны Вороного:
