...
* Основной способ: через `модуль Processing (Инструменты анализа) <https://docs.nextgis.ru/docs_ngqgis/source/processing.html>`_. Этим способом пользоваться удобнее. Некоторые инструменты доступны только в нём.
...
Также некоторые отдельные операции доступны через меню Вектор.
...
Вызываются через панель Инструменты анализа или меню Вектор ‣ Анализ.
