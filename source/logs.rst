...
#. Проверяем, что включен Журнал (кнопка с красным кружком).
...
#. В панели “Инструменты отладки” нажимаем очистить журнал.
#. Выполняем целевое действие, дожидаемся ошибки или другого проявления проблемы.
#. Сохраняем журнал и отправляем его в поддержку: support@nextgis.com. Если это первое письмо, то нужно сопроводить его подробным описанием проблемы.
