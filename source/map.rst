...
Как правило, при добавлении слоя кодировка распознаётся автоматически. Если в таблице атрибутов вы увидите нечитаемые символы, переключите кодировку в свойствах слоя, и переоткройте таблицу атрибутов. 

.. figure:: _static/ngq_encoding_change_ru.png
   :name: ngq_encoding_change_pic
   :align: center
   :width: 20cm

   Установка кодировки в свойствах слоя

Например файлы формата Mapinfo TAB хранятся в кодировке Windows-1251, однако она не всегда правильно распознаётся.

Обратите внимание, что кодировка System, которую можно выбрать в меню, будет зависеть от вашей операционной системы. При работе в **Windows** это Windows-1251, при работе в **Linux** - UTF-8.
...
.. note:: Чтобы добавить объекты, координаты которых записаны в таблице Excel, сохраните лист в формате CSV.
