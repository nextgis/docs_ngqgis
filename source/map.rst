...
"Система координат" (см. рисунок :numref:`ngqgis_coordinate_systemc_configuration_pic`). 
Указанное значение будет использоваться по всех последующих сеансах работы.

Окно Параментры сети представлено на рисунке см. :numref:`ngqgis_coordinate_systemc_configuration_pic`:

.. figure:: _static/coordinate_systemc_configuration.png
   :name: ngqgis_coordinate_systemc_configuration_pic
   :align: center
   :width: 10cm
...
На рисунке :numref:`ngqgis_coordinate_systemc_configuration_pic` показаны 
возможные варианты:
...
(см. рисунок :numref:`ngqgis_coordinate_systemc_configuration_pic`). 
...
:numref:`ngqgis_reprojection_on_the_fly_pic`). Значок  Преобразование 
...
.. figure:: _static/reprojection_on_the_fly.png
   :name: ngqgis_reprojection_on_the_fly_pic
   :align: center
   :width: 10cm
...
компонентов, показанных на рисунке :numref:`ngqgis_reprojection_on_the_fly_pic` 
и описанных ниже.
...
результат с известными значениями вашей проекции :numref:`ngqgis_user_coordinate_system_pic`).

.. figure:: _static/user_coordinate_system.png
   :name: ngqgis_user_coordinate_system_pic
   :align: center
   :width: 10cm
...
* **Тип символа** - символы различаются по типу: для точечных, линейных и 
  полигональных слоёв символы различаются. Это не изменяется. Сами символы могут состоять из одного или нескольких символьных слоёв. 
...
применен отрисовка.
Рисунок :numref:`ngqgis_dialogue_rendering_unique_values_pic иллюстрирует диалог 
...
.. figure:: _static/dialogue_rendering_unique_values.png
   :name: ngqgis_dialogue_rendering_unique_values_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_00.png
   :name: ngqgis_styles_heatmap_00_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_01.png
   :name: ngqgis_styles_heatmap_01_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_02_owngradient.png
   :name: ngqgis_styles_heatmap_02_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_03_gradienttransparent.png
   :name: ngqgis_styles_heatmap_03_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_04_quick.png
   :name: ngqgis_styles_heatmap_04_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_05_quality.png
   :name: ngqgis_styles_heatmap_05_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_06_discret-quality.png
   :name: ngqgis_styles_heatmap_06_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_07_discret-quick.png
   :name: ngqgis_styles_heatmap_07_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_08_bigradius.png
   :name: ngqgis_styles_heatmap_08_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_09_smallradius.png
   :name: ngqgis_styles_heatmap_09_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_10_radiusverybig.png
   :name: ngqgis_styles_heatmap_10_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_11_maxvalueauto.png
   :name: ngqgis_styles_heatmap_111_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_11_maxvaluelow.png
   :name: ngqgis_styles_heatmap_112_pic
   :align: center
   :width: 10cm
...
.. figure:: _static/styles_heatmap_13_complexgradient.png
   :name: ngqgis_styles_heatmap_13_pic
   :align: center
   :width: 10cm
...
..   :name: ngqgis_styles_heatmap_14_pic
..   :align: center
..   :width: 10cm
...
..   :name: ngqgis_styles_heatmap_15_pic
..   :align: center
..   :width: 10cm
..   
