...
После установки модуль появится в Панели подключаемых модулей: |button_copy_coord|. 

Также активировать модуль можно в меню Модули ‣ Copy Coords ‣ Copy Coords.

.. |button_copy_coord| image:: _static/button_copy_coord.png
   :width: 8mm


Курсор превратится в зелёную стрелку. Теперь клик по карте копирует координаты точки в буфер обмена. Вставить данные из буфера можно обычным способом.
