...
Запустите инструмент привязки растров: ``Растр ‣ Привязка растров``. Далее описываются команды инструмента Привязка Растров.
...
Точки можно сохранить отдельно на случай сбоев, командой "Файл ‣ Сохранить контрольные точки как". Сохраните их в путь по умолчанию, и они будут подтягиваться автоматически при следующем запуске инструмента Привязка растров. 
...
Проверьте параметры трансформации, открыв ``Параметры ‣ Параметры трансформации``.
...
Вы можете проанализировать невязки визуально, изменяя настройки прозрачности и режим смешивания в свойствах слоя (например для сравнения ортофотопланов и спутниковых снимков подходит режим смешивания "Направленный свет").
...
В окне привязки растров откройте файл с отсканированной картой. Приблизьтесь в левый верхний угол. 
...
.. note:: Точки также можно сохранить на диск, на случай сбоев, командой «Файл ‣ Сохранить контрольные точки как». Сохраните их в путь по умолчанию, и они будут подтягиваться автоматически при следующем запуске модуля Привязки растров.
